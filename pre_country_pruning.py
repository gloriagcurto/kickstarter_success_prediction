...
# Keep countries with a percentage of successful projects of at least 60% 
keep_p = p_success[p_success.percentages >= 60]
print(f'Number of countries with more than 60% of successful projects: {len(keep_p)}')
keep = keep_p.merge(right=df_counts, how='inner', left_on='countries', right_on='country')
keep.to_csv('../../data/keep_countries_60success.csv')
'''
Keep countries with more than 60% of successful projects ands more than 50 projects:
countries:
United Kingdom, Hong Kong, Japan, Singapore, China, Poland, South Korea, Taiwan, Israel, Russia, Indonesia, Greece, Kenya, Iceland, Slovenia, Portugal, Luxembourg, Finland, Cuba, Nepal
