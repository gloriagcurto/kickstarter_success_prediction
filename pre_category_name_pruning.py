...
keep = p_success[p_success.percentages >= 60]
print(len(keep))
...
to_drop = ['category_name_Workshops', 'category_name_Dance', 'category_name_Performances', 'category_name_Residencies', 'category_name_Immersive', 'category_name_Festivals', 'category_name_Musical', 'category_name_Theater', 'category_name_Comedy', 'category_name_Plays', 'category_name_Experimental', 'category_name_Graphic Novels', 'category_name_Anthologies', 'category_name_Webcomics', 'category_name_Comic Books', 'category_name_Comics', 'category_name_Academic', 'category_name_Action', 'category_name_Animals', 'category_name_Animation', 'category_name_Apps', 'category_name_Architecture', 'category_name_Audio', 'category_name_Bacon', 'category_name_Blues', 'category_name_Calendars', 'category_name_Camera Equipment', 'category_name_Candles', 'category_name_Ceramics', 'category_name_Childrenswear', 'category_name_Civic Design', 'category_name_Community Gardens', 'category_name_Conceptual Art', 'category_name_Cookbooks', 'category_name_Couture', 'category_name_Crochet', 'category_name_DIY', 'category_name_DIY Electronics', 'category_name_Digital Art', 'category_name_Drama', 'category_name_Drinks', 'category_name_Electronic Music', 'category_name_Embroidery', 'category_name_Events', 'category_name_Fabrication Tools', 'category_name_Faith', 'category_name_Family', 'category_name_Fantasy', "category_name_Farmer's Markets", 'category_name_Farms', 'category_name_Fine Art', 'category_name_Flight', 'category_name_Food Trucks', 'category_name_Footwear', 'category_name_Games', 'category_name_Gaming Hardware', 'category_name_Glass', 'category_name_Graphic Design', 'category_name_Hip-Hop', 'category_name_Horror', 'category_name_Installations', 'category_name_Interactive Design', 'category_name_Jewelry', 'category_name_Kids', 'category_name_Latin', 'category_name_Literary Journals', 'category_name_Live Games', 'category_name_Makerspaces', 'category_name_Metal', 'category_name_Mixed Media', 'category_name_Mobile Games', 'category_name_Movie Theaters', 'category_name_Music Videos', 'category_name_Nature', 'category_name_Painting', 'category_name_People', 'category_name_Performance Art', 'category_name_Periodicals', 'category_name_Pet Fashion', 'category_name_Photo', 'category_name_Places', 'category_name_Poetry', 'category_name_Print', 'category_name_Printing', 'category_name_Punk', 'category_name_Quilts', 'category_name_R&B', 'category_name_Radio & Podcasts', 'category_name_Ready-to-wear', 'category_name_Restaurants', 'category_name_Robots', 'category_name_Romance', 'category_name_Science Fiction', 'category_name_Sculpture', 'category_name_Small Batch', 'category_name_Software', 'category_name_Sound', 'category_name_Space Exploration', 'category_name_Spaces', 'category_name_Stationery', 'category_name_Taxidermy', 'category_name_Television', 'category_name_Textiles', 'category_name_Thrillers', 'category_name_Translations', 'category_name_Vegan', 'category_name_Video', 'category_name_Video Art', 'category_name_Wearables', 'category_name_Weaving', 'category_name_Web', 'category_name_Woodworking', 'category_name_World Music', 'category_name_Young Adult', 'category_name_Zines']
